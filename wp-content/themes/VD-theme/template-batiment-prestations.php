    ...
    <div class="page-content">
        ...
        <div class="prestations-all-boxes">
            <div class="prestations-boxes-left">
                <div class="prestations-box1-left"><?= $batiment_prestations_subtittle_1_box_left_1 ?>
                </div>
                <div class="prestations-box2-left"><?= $batiment_prestations_subtittle_1_box_left_2 ?>
                </div>
                <div class="prestations-box3-left"><?= $batiment_prestations_subtittle_1_box_left_3 ?>
                </div>
            </div>
            <div class="prestations-boxes-right">
                <div class="prestations-box1-right"><?= $batiment_prestations_subtittle_1_box_right_1 ?>
                </div>
                <div class="prestations-box2-right"><?= $batiment_prestations_subtittle_1_box_right_2 ?>
                </div>
                <div class="prestations-box3-right box-slide-click">
                    <span><?= $batiment_prestations_subtittle_1_box_right_3 ?></span>
